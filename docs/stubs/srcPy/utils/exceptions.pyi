...
class BaseError(RuntimeError):
    """Exception raised when base occurs."""
    msg: Incomplete
    code: Incomplete
    details: Incomplete
...
class AggregateError(DataError):
    """Exception raised when aggregate occurs."""
    errors: Incomplete
...
class DataFetchError(DataError):
    """Exception raised when data fetch occurs."""
...
class APIConnectionError(DataFetchError):
    """Exception raised when api connection occurs."""
...
class StreamConnectionError(DataFetchError):
    """Exception raised when stream connection occurs."""
...
class DataTimeoutError(DataFetchError):
    """Exception raised when data timeout occurs."""
...
class SchemaValidationError(DataValidationError):
    """Exception raised when schema validation occurs."""
...
class FileFormatError(DataValidationError):
    """Exception raised when file format occurs."""
...
class StatisticalTestError(DataError):
    """Exception raised when statistical test occurs."""
...
class DataDriftError(StatisticalTestError):
    """Exception raised when data drift occurs."""
...
class IBKRConnectionError(StreamConnectionError):
    """Exception raised when ibkr connection occurs."""
...
class ConfigValidationError(DataError):
    """Exception raised when config validation occurs."""
...
class PreprocessingError(DataError):
    """Exception raised when preprocessing occurs."""
...
class ModelTrainingError(DataError):
    """Exception raised when model training occurs."""
...
class TradingExecutionError(DataError):
    """Exception raised when trading execution occurs."""
...
class ModelInferenceError(DataError):
    """Exception raised when model inference occurs."""
